<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix'); ?>>
		...
		<div class="et_pt_blogmeta <?php echo (!$thumbnail_url)  ? 'esa_nothumbnail' : '' ?>">
			<?php 
				echo "<a href='http://opendefinition.org/licenses/cc-by/' target='_blank'>CC</a> by <a href='"; bloginfo('url'); echo "?s=&post_type=story&author="; the_author_meta('ID'); echo "'>"; the_author(); echo "</a>";
