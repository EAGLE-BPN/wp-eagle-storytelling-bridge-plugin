...
add_action('add_meta_boxes', function () {
	add_meta_box(
			...
			'Copyright Info',
			function($post) {
				echo  "<p>Your Story will be published under the <a href='http://opendefinition.org/licenses/cc-by/' target='_blank'>open</a> licence <a href='https://creativecommons.org/licenses/by/4.0/' target='_blank'>CC BY 4.0</a></p>.";
			},
			'story'
	);
});
